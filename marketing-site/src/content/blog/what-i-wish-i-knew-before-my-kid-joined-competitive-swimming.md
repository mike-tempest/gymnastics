...
We easily spend £100-150 per month when you factor everything in. More during heavy competition months. Good clubs use proper [billing systems](/features/billing) to keep track transparently.
...
4. **County Level**: Qualifying times for County Championships
5. **Regional Level**: Faster qualifying times, multi-day competitions
6. **National Level**: Top swimmers competing across the country
7. **Elite/Olympic pathway**: Tiny percentage who go further
...
Modern tools help enormously. Some clubs still rely on spreadsheets and group chats, which works until someone needs to find last year's medical form at 6am on a Sunday. Others use purpose-built platforms that handle everything from [billing](/features/billing) to [meet entries](/features/competitions), with [parent portals](/features/parent-portal) for easy access to information. If you're choosing between clubs, ask how they manage admin. It matters more than you'd think.
