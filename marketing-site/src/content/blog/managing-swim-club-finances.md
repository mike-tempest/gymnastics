...
**Grants.** Swim England, Sport England, local authorities, and community foundations all offer grants for various purposes. These are worth pursuing but take time to apply for and are never guaranteed. Our [guide to UK grants and funding for swimming clubs](/blog/swim-club-grants-and-funding-uk/) lists the current funders, the amounts they award, and how to apply.
...
**Be open about challenges.** If pool hire costs are increasing, or if the club is running a deficit, tell the membership. Hiding financial problems never ends well. Members generally respond positively when they are treated as partners in solving the problem rather than being presented with a sudden fee increase without context. If a rise is coming, our guide to [raising swim club fees without losing members](/blog/how-to-raise-swim-club-fees/) sets out the notice, approval and communication steps to take first.
...
Many people avoid the treasurer role because it sounds daunting. In practice, with the right systems in place, it is entirely manageable. The key is to set up clear processes from the start, automate what you can, report regularly, and ask for help when you need it. An unsustainable, manual workload is the [single biggest reason treasurers resign mid-term](/blog/why-your-swim-club-treasurer-quits/), and it is almost always a systems problem rather than a people one.

A well-organised club with [modern financial management tools](/features/billing) will find that the treasurer's workload is measured in hours per month, not hours per week. Automated Direct Debit collection, integrated financial reporting, and real-time membership payment status mean less time reconciling spreadsheets and more time supporting the club's financial health.
...
**Further reading:** [How to collect swim club fees](/blog/how-to-collect-swim-club-fees) compares five payment methods side by side. If your club is exploring new software, our guide to [evaluating swim club software](/blog/how-to-choose-swimming-club-management-software-uk/) covers the ten questions your committee should ask. See how Swimly's [billing automation](/features/billing) and [attendance tracking](/features/attendance) work together, then [join the founding club programme](/founding-clubs) for hands-on migration support and [transparent pricing](/#pricing).
