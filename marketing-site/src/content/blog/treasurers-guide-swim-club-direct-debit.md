...
The downside? You need a payment provider like [GoCardless](https://gocardless.com) or [Stripe](https://stripe.com). You can't just give out your club's bank details and start pulling money (thankfully — that would be terrifying).
...
- Integrates with [swim club management software](/swim-club-management-software/) (if you're using any)
...
> **Collection date: [day] of each month**
>
> Please set up your Direct Debit by [deadline]: [GoCardless payment link]
>
...
1. **GoCardless account access** (email, password, 2FA recovery codes)
2. **Bank account access** (online banking credentials, card reader if needed)
3. **Reconciliation process** (your system, even if it's a spreadsheet — document it)
4. **Arrears list** (who owes what, what's already been done about it)
5. **Annual calendar** (renewal dates, fee changes, when reports are due)
...
Full disclosure: I built [Swimly](/) because I got sick of watching volunteer treasurers drown in spreadsheet hell. Modern [swim club management software](/swim-club-management-software) like [Swimly's billing system](/features/billing) integrates Direct Debit with [membership management](/features/membership), so payments automatically link to member records. But SwimClub Manager, TeamUnify, and others do similar jobs. The key is centralising data so it's not trapped in one person's brain.
...
1. Don't panic
2. Check GoCardless dashboard first (usually the answer is there)
3. Screenshot everything (you'll need it for support tickets)
4. Contact GoCardless support (they're actually helpful, unlike most payment companies)
5. Communicate with affected parents (keeping them informed reduces complaints)
