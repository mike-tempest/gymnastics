...
### Grants and Swim England Funding

The Sport England Movement Fund, local council community grants, and Swim England regional and county club funds all exist, but they're competitive and often restricted-use. (Swim England replaced the old ASA name back in 2017, so if your paperwork still says "ASA funding", it's due an update.)
...
When you are ready to apply, our [guide to UK grants and funding for swimming clubs](/blog/swim-club-grants-and-funding-uk/) sets out the current funders, what they typically award, and how to put a bid together.
...
This is your biggest line item. Get the exact rate from your pool operator **in writing** for next season, and treat it as a rate you can [negotiate](/blog/pool-hire-for-swim-clubs/) rather than one you simply accept.
...
If you're still on spreadsheets, budget £0 here (but also budget the cost of your treasurer's time and sanity, which is harder to measure).

If you use [club management software](/swim-club-management-software), membership systems, payment collection tools, or registration platforms, add those subscriptions here. If you're evaluating platforms, our [pricing](/pricing) page shows transparent costs, and comparisons like [TeamUnify](/compare/teamunify) or [Club Organiser](/compare/cluborganiser) help you understand what different systems offer.

Many clubs are now budgeting £1,200-£2,500/year for software that automates billing, [attendance](/features/attendance/), and compliance tracking. The payback is fewer hours chasing payments and fewer errors.
...
1. Find £6,000-£7,000 of cost savings (good luck)
2. Raise the subs and explain why
...
This doesn't fix a fundamentally broken budget, but it makes tracking and collecting dramatically easier. For the day-to-day money side once the budget is set, see our [guide to managing swim club finances](/blog/managing-swim-club-finances/) and the [treasurer's guide to Direct Debit](/blog/treasurers-guide-swim-club-direct-debit/).

At [Swimly](/), we are building tools specifically for volunteer treasurers who did not sign up to be accountants but got handed a spreadsheet and a prayer. [Automated billing](/swimming-club-billing-software) takes the payment chasing off your plate, while [membership management](/features/membership) keeps your records clean and your compliance up to date. If you are curious about how modern software can reduce your admin burden, [become a founding club](/founding-clubs) and get 6 months free on any plan with white-glove migration.

## Frequently asked questions

### What percentage of a swim club's budget goes on pool hire?

For most UK swimming clubs pool hire is the single biggest cost, usually 40 to 60 per cent of total spending, with coaching the next largest line. The exact split depends on your pool rate and how many hours you train, so get next season's hourly rate in writing before you build the budget rather than assuming last year's figure.

### How do you budget for missed swim club subscription payments?

Do not assume you will collect from everyone. Budget for around 95 per cent collection at best, and allow for a mid-season dropout rate of roughly 8 to 12 per cent plus 3 to 5 per cent slippage from late or missed payments. Collecting subscriptions by Direct Debit reduces missed payments and the treasurer time spent chasing them.

### How much contingency should a swim club budget include?

A sensible rule is to add about 10 per cent of your total costs as contingency. On a 60,000 pound budget that is roughly 6,000 pounds you hope not to spend but will be glad to have when a pool rate rises mid-season, a coach needs covering, or several families move away.

### Can a swimming club budget for grants it has not yet been awarded?

No. Only put grants you have already been awarded into your baseline budget. Treat hoped-for funding as separate from committed income, because building a budget around a grant that has not been applied for or confirmed is a common way for clubs to end up in deficit.

### How much employer National Insurance does a swim club pay on coach salaries?

For the 2026 to 2027 tax year, employers pay secondary Class 1 National Insurance at 15 per cent on each employee's earnings above the 5,000 pound a year secondary threshold. Clubs that employ coaches should budget for this on top of gross pay, along with auto-enrolment pension contributions where they apply.
