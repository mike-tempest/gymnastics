...
Tracking who needs a check, when their last one was completed, and when renewal is due is one of the most common areas where clubs fall behind. A single spreadsheet can quickly become outdated, especially when volunteers change roles or new helpers join mid-season. If your club is still relying on manual tracking, you may find our article on [the hidden cost of spreadsheet club management](/blog/the-hidden-cost-of-spreadsheet-club-management) uncomfortably familiar.
...
- [Session attendance registers](/features/attendance) demonstrating duty of care
...
**Letting DBS checks lapse.** Without a reliable tracking system, it is remarkably easy for renewals to slip through the cracks. A coach whose DBS check expired six months ago is a compliance gap that could have serious consequences. Automated tracking systems prevent this — compare platforms on our [SwimClub Manager comparison](/compare/swimclubmanager) and see [pricing](/pricing).
...
For clubs that recognise these patterns, our article on [why UK swimming clubs deserve better software](/blog/why-uk-swim-clubs-deserve-better-software/) explores how the right tools can help committees work more effectively across all areas of [club admin](/swim-club-management-software)istration, safeguarding included.
...
Swimly helps clubs manage DBS tracking, document storage, and compliance records in one place. Visit [swimly.uk](/) to see how it works.

## Frequently asked questions

### Is Wavepower compliance mandatory for swimming clubs?

Yes. Wavepower is a condition of affiliation with Swim England, not an optional set of guidelines. Every affiliated club is expected to operate in line with it, and failing to meet these obligations can lead to sanctions, suspension, or removal from Swim England.

### Who needs an enhanced DBS check at a swimming club?

Anyone in a role involving regular, unsupervised contact with children needs an enhanced DBS check. This typically includes coaches, assistant coaches, team managers, and poolside helpers, as well as the Club Welfare Officer.

### How often do DBS checks need to be renewed under Wavepower?

Swim England's policy requires DBS checks to be renewed at regular intervals, typically every three years, unless the person has subscribed to the DBS Update Service. There is no fixed legal expiry on a certificate, so clubs need to track renewal dates themselves.

### Who is responsible for safeguarding in a swimming club?

Every club must appoint a Club Welfare Officer as the primary contact for safeguarding concerns, and they must complete Swim England training such as Time to Listen and hold a current enhanced DBS check. Safeguarding is a whole-club responsibility, though, with the committee, coaches, and volunteers all playing a part.

### What should a club do when a safeguarding concern is raised?

Pass the concern to the Club Welfare Officer as soon as possible. The club's role is to listen, record, and refer, never to investigate allegations itself. The Club Welfare Officer then follows Wavepower's reporting procedures, which may involve Swim England's Child Safeguarding Team, the local authority's children's services, or the police in urgent cases. Record every concern in writing, even minor ones.

### How often is Wavepower updated?

Swim England updates Wavepower periodically to reflect changes in legislation, best practice, and learning from safeguarding cases. There is no fixed schedule, so your Club Welfare Officer and committee should always work from the current edition published on the Swim England website.

---

**Simplify your compliance.** Swimly's [Wavepower compliance tools](/features/compliance) help you track DBS checks, safeguarding training, and policy acknowledgements automatically. Running a [swim school](/swim-school-management)? Compliance tracking covers your learn-to-swim staff too.
