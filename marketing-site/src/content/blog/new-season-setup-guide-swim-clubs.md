...
**DBS checks current for all coaches, poolside helpers, and committee members with swimmer contact.** The standard is an Enhanced DBS check. Keep a register with check dates and renewal deadlines. If someone's check has lapsed, they cannot be on poolside unsupervised. No exceptions. Track [attendance](/features/attendance) to identify which volunteers are regularly poolside and therefore require checks.
...
But modern [club management software](/swim-club-management-software) can compress weeks of manual setup into days:

- **[Online registration](/features/membership/)** with pre-populated returning member data
- **Automated squad allocation** based on coach recommendations
- **[Direct Debit billing](/features/billing/)** that collects fees automatically each month
- **[Compliance tracking](/features/compliance/)** with DBS expiry alerts and Wavepower checklists
- **[Parent communication](/features/parent-portal/)** through a single platform instead of scattered WhatsApp groups
