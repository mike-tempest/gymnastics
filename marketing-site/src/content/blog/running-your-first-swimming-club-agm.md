---
title: 'Running Your First Swimming Club AGM: The Complete Guide for New Committee Members'
description: "Taking on your first AGM as secretary or chair? This comprehensive guide covers legal requirements, agenda templates, common mistakes, and exactly what needs to happen before, during, and after your club's Annual General Meeting."
pubDate: '2026-03-06'
updatedDate: '2026-07-04'
author: 'Mike Tempest'
tags: ['agm', 'committee', 'governance', 'first-time', 'club-management']
seoTitle: 'How to Run a Swimming Club AGM: Complete Guide for First-Timers'
seoDescription: "Run your swimming club's AGM with confidence: legal requirements, agenda template, election procedures, and the post-meeting handover."
faqItems:
  - question: 'How much notice do we need to give for a swim club AGM?'
    answer: "Check your club constitution - most require 21 or 28 days' written notice to all members. The notice must include the date, time, venue, and proposed agenda. Email usually counts as written notice, but verify your constitution's requirements."
  - question: 'What is quorum for a swimming club AGM?'
    answer: "Quorum (minimum attendance for valid decisions) is set in your constitution. Typical quorums are 10-15 members for small clubs, 20-25 for medium clubs, or 10% of total membership. If quorum isn't reached, the meeting must be rescheduled."
  - question: 'Do we need audited accounts for our swim club AGM?'
    answer: "Most swim clubs don't require a full audit. Clubs with income under £25,000 typically need an independent examination - someone not on the committee reviews accounts and confirms they appear reasonable. Larger clubs may need a formal audit. Check your constitution and Swim England affiliation requirements."
  - question: 'Can we hold a swim club AGM online or hybrid?'
  ...
  - question: 'What happens if nobody wants to be treasurer?'
    answer: 'Options: (1) Split the role - one person handles day-to-day payments, another prepares annual accounts. (2) Existing committee co-opts someone during the year. (3) Appoint a non-committee volunteer to handle finances under committee oversight. (4) Consider paid bookkeeping support if budget allows. Last resort: role remains vacant but must be filled within a reasonable period.'
  - question: 'How long should AGM minutes be?'
    answer: "AGM minutes should be concise - 2-3 pages maximum. Record: date, attendees, decisions made, votes taken, actions agreed, election results. Don't transcribe every comment. Minutes should be circulated within 14 days and approved at next year's AGM."
  - question: 'Can we change our swim club constitution at the AGM?'
    answer: "Yes, but most constitutions require: (1) 28 days' notice with full wording of proposed changes, (2) two-thirds majority to pass (not simple majority), (3) Swim England approval if changes affect affiliation requirements. Constitutional changes are serious - consider seeking advice from your regional Swim England office before proposing changes."
  - question: "What if we don't reach quorum at our AGM?"
    answer: "If attendance falls short of quorum, you cannot make binding decisions. Options: (1) Wait 15 minutes for latecomers, (2) reschedule for 2-3 weeks later (check your constitution for requirements), (3) some constitutions allow a second meeting with lower quorum if the first fails. Whatever you do, don't proceed without quorum - decisions can be challenged."
---
...
## Legal Requirements: What Your Constitution Actually Requires
...
Some constitutions require specific reports (safeguarding via [compliance](/features/compliance), coaching, [membership](/features/membership)).
...
**Identify committee vacancies:**
Contact current committee to confirm who's standing down. Core roles needing election/re-election typically include:
...
Don't wait until the night to ask for volunteers. Identify potential candidates and approach them personally: "Would you consider standing for treasurer? I think you'd be brilliant at it."
...
**Request standing committee reports:**
Ask each role holder to prepare a brief report (1-2 paragraphs maximum):
...
**Secretary prepares annual report:**
...
**Confirm nominations received:**
If you've received no nominations for critical roles (treasurer, safeguarding), you have a problem. Time for urgent phone calls.
...
**Uncontested roles** (one nominee):
Simple show of hands: "All in favour of electing Jane Smith as Treasurer?" If clear majority, elected.

**Contested roles** (multiple nominees):
Each candidate given 2 minutes to speak (optional). Secret ballot if more than 2 candidates, show of hands if just 2. Highest vote wins.

**No nominees:**
Role declared vacant. Existing committee can co-opt someone during the year, but you need this recorded in minutes. If it's a critical role (treasurer, safeguarding), consider adjourning AGM for 2 weeks to find someone.

**Retiring committee member in contested race:**
They can vote in their own election (check your constitution, but this is normal).
...
_Need help managing your club's membership, billing, and administration after the AGM? [Swimly](/) handles the day-to-day with automated [membership management](/features/membership), [billing](/features/billing), and [attendance tracking](/features/attendance) so your new committee can focus on what matters - the swimming, not the spreadsheets._
...
_Mike Tempest is a swim parent, CTO at Risika, and founder of [Swimly](/) - swim [club management software](/swim-club-management-software) built by someone who knows what AGM season actually feels like._
