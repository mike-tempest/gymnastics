---
title: "How to Collect Swim Club Fees: A Treasurer's Guide to Getting Paid on Time"
description: 'Compare 5 ways to collect swim club fees: bank transfer, standing order, Direct Debit, card and cash, with cost, time saved and GDPR notes.'
pubDate: '2026-03-02'
author: 'Mike Tempest'
tags: ['swim clubs', 'treasurer', 'billing', 'payments', 'direct debit']
---
...
**How it works:** Parents authorise the club to collect payments from their bank account. The club (via a Direct Debit provider like GoCardless) controls when and how much to collect. Failed payments are automatically retried. Modern [swimming club payment software](/swimming-club-payment-software) and [swim club billing software](/swimming-club-billing-software) integrate Direct Debit collection directly into your membership management platform.
...
| Method                      | Transaction Fee   | Monthly Fee | Cost per £5,000 Collected | Annual Cost (£60,000) |
| --------------------------- | ----------------- | ----------- | ------------------------- | --------------------- |
| **Bank transfer**           | £0                | £0          | £0                        | £0                    |
| **Standing order**          | £0                | £0          | £0                        | £0                    |
| **GoCardless Direct Debit** | 1% + 20p (cap £2) | £0          | ~£50-60                   | ~£600-720             |
| **Stripe card payments**    | 1.5% + 20p        | £0          | ~£75-85                   | ~£900-1,020           |
| **PayPal**                  | 2.9% + 30p        | £0          | ~£145-160                 | ~£1,740-1,920         |
| **Cash/cheque**             | £0                | £0\*        | £0\*                      | £0\*                  |
...
| Method             | GDPR Risk | Audit Trail                                       | Data Security                                    |
| ------------------ | --------- | ------------------------------------------------- | ------------------------------------------------ |
| **Bank transfer**  | Medium    | Poor (unless you keep detailed records)           | Low (bank handles it)                            |
| **Standing order** | Medium    | Poor (you only see the payment, not the setup)    | Low (bank handles it)                            |
| **GoCardless**     | Low       | Excellent (full payment history, mandate records) | High (PCI-compliant, encrypted)                  |
| **Card payments**  | Low       | Good (transaction history in Stripe/PayPal)       | High (PCI-compliant, you never see card numbers) |
| **Cash**           | High      | Very poor (manual receipts only)                  | Very low (physical security risk)                |
...
1. Go to [gocardless.com](https://gocardless.com)
...
### Step 3: Send Mandate Links to Parents (20 minutes for 120 families)
...
Unlike older platforms like [Club Organiser](/compare/cluborganiser), Swimly's [parent portal](/features/parent-portal) gives families real-time visibility of their payment history and upcoming charges.

**Learn more:** [Swimly Billing Features](/features/billing)
...
Modern systems like [Swimly's billing features](/features/billing) integrate GoCardless directly with your membership database, eliminating manual reconciliation entirely. Combined with [membership management](/features/membership) and automated [parent communications](/features/parent-portal), the entire payment collection process becomes hands-off.
...
If you want a system that handles all of this automatically, take a look at [swim club management software](/swim-club-management-software) built specifically for UK clubs.
...
And if you're building a modern swim club that values volunteers' time as much as swimmers' progress, [Swimly's billing features](/features/billing) bring all of this together in one platform: Direct Debit collection, automated reminders, financial reporting, and [squad management](/features/membership), all designed specifically for British swimming clubs. See how [attendance tracking](/features/attendance), [compliance management](/features/compliance), and billing work together across all our [features](/features).
...
**Ready to simplify your club's billing?**  
Join Swimly's [founding club programme](/founding-clubs) and get 6 months free on any plan, plus white-glove migration from your current setup. View our [transparent pricing](/pricing) or [join the waitlist →](/#waitlist)
