...
Before the meet, your club will receive a "heat sheet" or "psych sheet" — essentially the running order for the entire competition managed through the [competition system](/features/competitions). It lists every event, every heat, every lane assignment, and every swimmer's entry time.
