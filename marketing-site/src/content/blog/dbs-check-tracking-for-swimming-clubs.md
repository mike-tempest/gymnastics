...
[Wavepower, Swim England's safeguarding policy](/blog/what-wavepower-compliance-actually-requires/), sets out the minimum requirements for DBS checks in affiliated clubs. As a general principle, anyone in a role that involves regular contact with children in a position of trust requires an enhanced DBS check.
...
The Update Service is a subscription that individuals can take out for a small annual fee. It [costs £16 per year, and is free for volunteers](https://www.gov.uk/dbs-update-service) who are not paid for the role beyond expenses, which covers most club coaches and poolside helpers. It keeps their DBS certificate current and allows employers and voluntary organisations to carry out online checks to confirm that no new information has been added since the original certificate was issued.
...
A DBS certificate has no statutory expiry date. However, [Swim England requires affiliated clubs to renew a member's DBS check every three years](https://www.swimming.org/swimengland/dbs-faqs/) for as long as that person stays in a role that needs one under Wavepower, and the three-year cycle is also reflected in the requirements for many coaching qualifications.

Because the certificate itself never formally expires, the three-year point is about your club's compliance obligation rather than the document going out of date. For Update Service subscribers, the club can confirm currency online at any time, so it does not have to wait for the three-year renewal to reassure itself that nothing has changed. For non-subscribers, processing a fresh enhanced check every three years is the practical standard.
...
**Stay current.** The tracking system is only useful if it reflects reality. Assign responsibility to a specific person (usually the [club welfare officer](/blog/swim-club-committee-roles-and-responsibilities/)) for keeping it updated whenever someone joins, leaves, or renews.
...
Modern [swim club management software](/swim-club-management-software) like [Swimly's compliance features](/features/compliance) can manage DBS tracking automatically, sending reminders to volunteers and flagging upcoming renewals for the welfare officer, removing the dependency on manual spreadsheet maintenance. Integrated with [membership management](/features/membership), you always know which volunteers are cleared to work with which squads, and the [mobile app](/features/mobile) lets coaches check compliance status poolside. Combined with [attendance tracking](/features/attendance), you can ensure only DBS-cleared volunteers supervise sessions.
...
DBS checks work best when they are part of a [broader culture of safeguarding](/blog/swimming-club-safeguarding-best-practices-2026/) rather than a box-ticking exercise. Volunteers who understand why checks are required, rather than simply being told they must have one, are more likely to renew promptly and to support the process.
...
### How often do DBS checks need renewing for swimming clubs?

A DBS certificate has no statutory expiry date, but Swim England requires affiliated clubs to renew a member's DBS check every three years for as long as they stay in a role that needs one under Wavepower. Where a volunteer is signed up to the DBS Update Service, the club can re-check the certificate online at any time instead of waiting for the three-year point.

### What level of DBS check do swimming club coaches and volunteers need?

For virtually any role involving regular contact with young swimmers, the right level is an enhanced DBS check with a children's barred list check. That covers head and assistant coaches, junior coaches, team managers, the club welfare officer and poolside helpers. Purely administrative roles with no unsupervised contact may not need one, but when in doubt it is safer to obtain the check.

### How much does the DBS Update Service cost?

The DBS Update Service costs £16 a year, and it is free for volunteers who are not paid for the role beyond expenses. You must subscribe within 30 days of the certificate being issued. Once subscribed, a club can carry out an online status check at any time to confirm nothing has changed, rather than applying for a fresh check.

### Can a coach use a DBS check from another club?

Not automatically. DBS checks are role-specific, so a check obtained for a previous club or employer does not transfer on its own. It can be reused only if the person is subscribed to the DBS Update Service and the new role is in the same workforce and needs the same level of check. Otherwise the club should process a new enhanced check.

### What should a club do if a volunteer's DBS check has lapsed?

Act at once. The volunteer should not have any unsupervised contact with young swimmers until a new check is obtained and cleared, so start the renewal immediately and put appropriate supervision in place meanwhile. Most lapses are administrative oversights, but if someone has been working in regulated activity with no check at all, take advice from your county welfare officer or Swim England before acting.

If you want to manage DBS check tracking alongside your wider membership and safeguarding records, professional [swim club management software](/swim-club-management-software) like [Swimly](/) was built to handle this for UK swimming clubs. Automated renewal reminders and a clear compliance dashboard mean your welfare officer always knows where things stand. For a detailed comparison of how Swimly and other platforms handle compliance tracking, see our guide to the [best swim club management software](/best-swim-club-software-uk/), or learn how [swim club management software](/swim-club-management-software) brings compliance, billing, and membership together. Unlike older systems like [Club Organiser](/compare/cluborganiser), Swimly's compliance tracking integrates with [billing](/features/billing) and [attendance](/features/attendance), so safeguarding is built into daily operations, not a separate spreadsheet. Explore all [Swimly features](/features) including [compliance](/features/compliance) and [membership management](/features/membership), view our [transparent pricing](/pricing), or [join the founding club programme](/founding-clubs) for hands-on migration support.
