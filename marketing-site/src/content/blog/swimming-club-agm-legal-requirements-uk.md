---
title: "Swimming Club AGM Legal Requirements: A Practical Guide for UK Clubs"
description: "What notice do you legally need for a swim club AGM? What counts as a quorum? A practical guide to AGM legal requirements for UK swimming clubs."
pubDate: "2026-03-01"
updatedDate: "2026-07-14"
author: "Mike Tempest"
tags: ["agm", "legal", "committee", "governance", "compliance"]
faqItems:
  - question: "What is the legal minimum notice period for a UK swim club AGM?"
    answer: "There is no single statutory notice period for an unincorporated association, which is what most UK swim clubs are. The binding figure is whatever your own constitution sets, and for swim clubs that is most commonly 21 or 28 days. Treat the constitution as the rulebook: if it says 21 days, giving 20 makes the meeting procedurally invalid. Where a constitution is silent, clubs usually adopt a reasonable period of at least 14 days, but the safe course is to give a clear four weeks so members have time to read the papers."
  - question: "Are AGM decisions still valid if we gave the wrong notice period?"
    answer: "If the notice fell short of what your constitution requires, decisions made at that meeting can be challenged and may be treated as invalid, especially contested ones such as a fee increase or a committee election. In practice, if nobody objects the decisions usually stand unquestioned. But if a decision was controversial, defective notice gives an unhappy member grounds to contest it. If you spot the error before the meeting, postpone and reissue notice with the correct timing; if you spot it afterwards, reconvene properly and re-vote on anything significant."
  - question: "Who can legally vote at a swimming club AGM?"
    answer: "Voting eligibility is set entirely by your club's constitution, not by any general law, so read it before the meeting. Common models are one vote per family, one vote per adult member, or one vote per fully paid-up member, which excludes anyone in arrears. Some small clubs restrict votes to committee members. Proxy and remote voting only count if the constitution explicitly allows them, so do not assume online votes are valid unless your rules say so."
  - question: "Can members propose their own motions at a swim club AGM?"
    answer: "Usually yes, if your constitution allows it, and most do. The typical process is that a member submits the motion in writing, it is seconded by another member, and it reaches the secretary by a stated deadline before the meeting, often 14 days beforehand, so it can be added to the agenda. Members can generally propose fee, policy or constitutional changes, but not specific spending decisions, which are the committee's job between AGMs, and nothing outside the club's stated objects."
  - question: "How long must a swim club keep its AGM records?"
    answer: "Keep signed AGM minutes permanently, because they are the club's constitutional record of decisions and elections. Keep financial accounts and attendance records for at least six years to meet HMRC expectations. Store them somewhere the whole committee can reach, not on one volunteer's personal laptop, and make sure they transfer cleanly at handover so the incoming committee inherits the history rather than starting blind."
---
...
Welcome to the least glamorous part of running a swim club. Let's make it simple. This guide focuses on the legal and constitutional rules that keep an AGM valid; if you also want the practical, step-by-step run of the meeting itself, see our guide to [running your first swimming club AGM](/blog/running-your-first-swimming-club-agm/).
...
**Who can vote**: Varies by club (members, parents, committee only, so check your rules)  
...
## Why AGM Legal Requirements Actually Matter
...
- Treasurer's report (full financial accounts as PDF from [billing system](/features/billing))
...
If you're proposing a constitutional change or significant fee increase, flag it clearly in the AGM notice. Surprising people at the meeting is legally fine (if it's on the agenda) but politically stupid.
...
This varies by club. Check your constitution:
...
- Other committee roles as defined in constitution (see [what each committee role actually does](/blog/swim-club-committee-roles-and-responsibilities/) if you are filling a vacancy)
...
**Who can vote?**
This is entirely determined by your constitution. Common models:
...
- Proxy votes (if your constitution allows them, and many swim club constitutions don't)
...
Only if your constitution explicitly allows it. Many older constitutions require physical presence. If your constitution is silent, assume remote voting isn't allowed.
...
Changing your [constitution](/blog/what-is-a-swim-club-constitution/) is harder than normal AGM business, and rightly so.
...
**Safeguarding note**:
Key roles (Chair, Secretary, anyone with access to children) require DBS checks. You can't legally require this for election, but you can make it a condition of taking office. Make this clear during nominations.
...
**Contentious motions**:
If someone's proposing something controversial (e.g., removing a committee member, changing affiliation status, major fee cuts), make sure you've taken advice. Your constitution should specify how to handle disputes.

## What If You Miss the Legal Deadline?
...
**Real-world nuance**:
If nobody challenges the AGM, invalid notice usually doesn't matter in practice. But if decisions were controversial (fee increases, committee elections), someone might use invalid notice as grounds to challenge. Better to get it right upfront.
...
- Handover: Make sure records transfer when the committee changes, using a [committee handover checklist](/blog/swimming-club-committee-handover-checklist/) so nothing is lost
...
### What is the legal minimum notice period for a UK swim club AGM?

There is no single statutory notice period for an unincorporated association, which is what most UK swim clubs are. The binding figure is whatever your own constitution sets, and for swim clubs that is most commonly 21 or 28 days. Treat the constitution as the rulebook: if it says 21 days, giving 20 makes the meeting procedurally invalid. Where a constitution is silent, clubs usually adopt a reasonable period of at least 14 days, but the safe course is to give a clear four weeks so members have time to read the papers.

### Are AGM decisions still valid if we gave the wrong notice period?

If the notice fell short of what your constitution requires, decisions made at that meeting can be challenged and may be treated as invalid, especially contested ones such as a fee increase or a committee election. In practice, if nobody objects the decisions usually stand unquestioned. But if a decision was controversial, defective notice gives an unhappy member grounds to contest it. If you spot the error before the meeting, postpone and reissue notice with the correct timing; if you spot it afterwards, reconvene properly and re-vote on anything significant.

### Who can legally vote at a swimming club AGM?

Voting eligibility is set entirely by your club's constitution, not by any general law, so read it before the meeting. Common models are one vote per family, one vote per adult member, or one vote per fully paid-up member, which excludes anyone in arrears. Some small clubs restrict votes to committee members. Proxy and remote voting only count if the constitution explicitly allows them, so do not assume online votes are valid unless your rules say so.

### Can members propose their own motions at a swim club AGM?

Usually yes, if your constitution allows it, and most do. The typical process is that a member submits the motion in writing, it is seconded by another member, and it reaches the secretary by a stated deadline before the meeting, often 14 days beforehand, so it can be added to the agenda. Members can generally propose fee, policy or constitutional changes, but not specific spending decisions, which are the committee's job between AGMs, and nothing outside the club's stated objects.

### How long must a swim club keep its AGM records?

Keep signed AGM minutes permanently, because they are the club's constitutional record of decisions and elections. Keep financial accounts and attendance records for at least six years to meet HMRC expectations. Store them somewhere the whole committee can reach, not on one volunteer's personal laptop, and make sure they transfer cleanly at handover so the incoming committee inherits the history rather than starting blind.

---

*Need help managing your swim club beyond the AGM? [Swimly](/) is modern [club management software](/swim-club-management-software) built for UK swimming clubs. Automated [billing](/features/billing), [member records](/features/membership), [attendance tracking](/features/attendance), and [Wavepower compliance](/features/compliance) all in one place.*


---

**Looking for a better way to run your club?** Compare [swim club management options](/compare/swimclubmanager/) or see [Swimly's pricing](/pricing/) to find out how much time your committee could save.
