# AGENTS.md - Gymnastics Platform Monorepo
...
- **Marketing site** (`marketing-site/`): Astro + Tailwind. Has its own AGENTS.md. Reskin is Phase 4 (TEM-25).
...
- Items marked _[verify at build time]_ in the brief must be re-checked against british-gymnastics.org before compliance copy ships.
...
- `.Codex/worktrees/**` (stale agent copies), `node_modules`, `dist` (regenerate, never hand-edit)
