...
const TEST_PAYMENT_AMOUNT = 50.00; // £50.00 for monthly subscription
...
async function runTests() {
  ...
  try {
    ...
    const { customerId, mandateId } = await testCompleteRedirectFlow(client, redirectFlowId, sessionToken);
