      ...
      <div className="flex items-center justify-between px-3 sm:px-6 py-3.5">
        ...
        <div className="flex-1 max-w-xl mx-2 sm:mx-4 md:mx-8">
          <div className="relative hidden sm:block">
            <label htmlFor="topbar-search" className="sr-only">Search swimmers, families, sessions</label>
            <input
              id="topbar-search"
              type="text"
              placeholder="Search swimmers, families, sessions..."
        ...
        <div className="flex items-center space-x-3">
          {/* Notifications */}
          <button aria-label="Notifications" className="relative p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center hover:bg-white/10 rounded-xl transition-colors text-text-secondary hover:text-white group">
            <svg
              className="w-5 h-5"
              fill="none"
              strokeLinecap="round"
            ...
            <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-brand rounded-full ring-2 ring-dark-primary" aria-hidden="true"></span>
          ...
          {session && (
            <div className="relative" ref={userMenuRef}>
              ...
              {/* Dropdown */}
              {showUserMenu && (
                <div role="menu" className="absolute right-0 mt-2 w-48 max-w-[calc(100vw-2rem)] bg-dark-primary rounded-xl shadow-xl border border-white/10 overflow-hidden">
                  <div className="py-1">
                    <button
                      role="menuitem"
