...
Club Membership,Annual club membership for all members,45.00,annual,club,
...
const IMPORT_CARDS: ImportCard[] = [
  ...
  },
  {
    ...
    title: 'Members',
    description:
      'Import members together with their parent and family details. Rows sharing a parent email are grouped into one family.',
