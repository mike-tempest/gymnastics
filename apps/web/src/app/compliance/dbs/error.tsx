  ...
  return (
    <div className="flex h-dvh items-center justify-center bg-dark-primary p-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-2xl font-bold text-white mb-2">Failed to load background check records</h2>
        <p className="text-text-secondary mb-6">{error.message || 'An error occurred whilst loading background check records. Please try again.'}</p>
