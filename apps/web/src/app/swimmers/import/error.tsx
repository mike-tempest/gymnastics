    ...
    <div className="flex h-dvh items-center justify-center bg-dark-primary p-4">
      <div className="text-center max-w-md">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/swimmers" className="px-6 py-3 min-h-[44px] rounded-xl font-semibold text-text-secondary border border-white/20 hover:border-brand hover:text-white transition-all inline-flex items-center justify-center">Back to Swimmers</Link>
        </div>
      </div>
    </div>
  );
