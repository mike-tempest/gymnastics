...
export default function InvoicesListPage() {
  ...
  const withStatus = invoices.map((inv) => ({ invoice: inv, displayStatus: getDisplayStatus(inv) }));
  ...
  return (
    <div className="min-h-dvh bg-canvas p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <Breadcrumb
          items={[{ label: 'Parent Portal', href: '/parent' }, { label: 'Invoices' }]}
        />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-dark-primary rounded-3xl p-6 md:p-8 shadow-lg border border-white/10">
              ...
              <p className="font-serif text-4xl text-yellow-400 tabular-nums">{formatCurrency(totalOutstanding)}</p>
            </div>
            ...
            <div className="bg-dark-primary rounded-3xl p-6 md:p-8 shadow-lg border border-white/10">
              ...
              <p className="font-serif text-4xl text-brand tabular-nums">{formatCurrency(totalPaid)}</p>
            </div>
          </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-4 ml-4">
                            ...
                            <svg className="w-5 h-5 text-text-tertiary group-hover:text-brand transition-colors flex-shrink-0" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                              <path d="M9 5l7 7-7 7" />
                            </svg>
                          </div>
                        </div>
