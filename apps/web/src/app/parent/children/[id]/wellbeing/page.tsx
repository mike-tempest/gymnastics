...
import { Heart, Battery, Moon, Waves, ChevronLeft, Info, Plus, Calendar } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex gap-1 bg-dark-primary rounded-xl p-1 border border-white/10">
          {(['checkin', 'history', 'cycle'] as const).map((tab) => (
            ...
            >
              {tab === 'checkin' ? 'Check-in' : tab === 'history' ? 'History' : 'Cycle Tracker'}
            </button>
          ))}
        </div>
        ...
        {activeTab === 'checkin' && (
          <form onSubmit={handleCheckInSubmit} className="space-y-6">
              ...
              <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-xl">
                <p className="text-green-400 text-sm font-medium">
                  ...
                  {todayLog?.readiness === 'green'
                    ? 'Looking great today!'
                    : todayLog?.readiness === 'amber'
                      ? 'Coach will be aware they may need a lighter session.'
                      : 'Coach will know they prefer land-based drills today.'}
                </p>
              </div>
            )}
            ...
            <div className="bg-dark-primary rounded-2xl p-6 border border-white/10 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold">
                    Sleep quality{' '}
                    <span className="text-text-secondary font-normal text-sm">(optional)</span>
                  </h3>
              ...
              {sleep && <p className="text-xs text-text-secondary">{levelLabel(sleep)}</p>}
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-text-secondary text-sm">
                    How comfortable do they feel getting in the pool today?
                  </p>
                </div>
              </div>
              <div className="flex gap-2">
            ...
            <div className="bg-dark-primary rounded-2xl p-6 border border-white/10 space-y-3">
              ...
              <p className="text-text-secondary text-sm">
                These are only visible to you. Coaches cannot see these notes.
              </p>
              <textarea
                value={notes}
            ...
            <div className="bg-brand/5 border border-brand/20 rounded-2xl p-6 space-y-3">
              ...
              <p className="text-text-secondary text-sm leading-relaxed">
                Coaches only see a simple green, amber, or red indicator next to your child&apos;s
                name on the attendance register. They never see the individual scores, notes, or any
                cycle data. This helps them adapt the session without any awkward conversations.
              </p>
            </div>
          </form>
        )}
              ...
              >
                ...
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-2">
                    Symptoms <span className="text-text-secondary font-normal">(optional)</span>
                  </label>
