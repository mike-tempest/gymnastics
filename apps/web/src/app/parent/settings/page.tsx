  ...
  return (
    <button
      ...
      className={`relative inline-flex h-7 w-12 min-h-[44px] min-w-[44px] items-center rounded-full transition-all ${
        enabled ? 'bg-brand shadow-glow-sm' : 'bg-white/5 border border-white/10'
      }`}
    >
      <span
  ...
  return (
    <div className="min-h-dvh bg-canvas p-6 sm:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <Breadcrumb
            items={[{ label: 'Parent Portal', href: '/parent' }, { label: 'Settings' }]}
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-dark-primary rounded-card p-6 md:p-8 shadow-card border border-white/10">
            ...
            <p
              className={`text-4xl font-bold ${preferences.smsEnabled ? 'text-brand' : 'text-text-tertiary'}`}
            >
            ...
            <div className="bg-white/5 rounded-2xl p-5">
              <div className="flex justify-between items-start">
                ...
                <ToggleSwitch
                  ...
                  onToggle={() =>
                    updatePreference('sessionReminders', !preferences.sessionReminders)
                  }
            ...
            <div className="bg-white/5 rounded-2xl p-5">
              <div className="flex justify-between items-start">
                ...
                <ToggleSwitch
                  ...
                  onToggle={() =>
                    updatePreference('invoiceNotifications', !preferences.invoiceNotifications)
                  }
            ...
            <div className="bg-white/5 rounded-2xl p-5">
              <div className="flex justify-between items-start">
                <div className="mr-4">
                  ...
                  <p className="text-text-tertiary text-sm mt-1">General club news and updates.</p>
                </div>
                <ToggleSwitch
                  enabled={preferences.clubAnnouncements}
                  onToggle={() =>
                    updatePreference('clubAnnouncements', !preferences.clubAnnouncements)
                  }
            ...
            <div className="bg-white/5 rounded-2xl p-5">
              <div className="flex justify-between items-start">
                <div className="mr-4">
                  ...
                  <p className="text-text-tertiary text-sm mt-1">
                    Receive important updates via text message. Message rates may apply. You can opt
                    out at any time.
                  </p>
                </div>
                <ToggleSwitch
          ...
          <div className="p-4 md:p-6">
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl">
                ...
                <span
                  className={preferences.sessionReminders ? 'text-brand' : 'text-text-tertiary'}
                >
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl">
                ...
                <span
                  className={preferences.invoiceNotifications ? 'text-brand' : 'text-text-tertiary'}
                >
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl">
                ...
                <span
                  className={preferences.clubAnnouncements ? 'text-brand' : 'text-text-tertiary'}
                >
        ...
        <div className="flex items-center gap-4">
          ...
          {saveMessage && <span className="text-brand font-semibold">{saveMessage}</span>}
        </div>
      </div>
    </div>
  );
