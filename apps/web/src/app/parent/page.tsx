    ...
    <div className="min-h-dvh bg-canvas p-6 sm:p-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-text-secondary text-lg">Welcome back. Here is your family overview.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-dark-primary rounded-card p-6 md:p-8 shadow-card border border-white/10">
            ...
            <p className="text-4xl font-bold text-brand tabular-nums">
              {dashboard?.childrenCount ?? members.length}
            </p>
          </div>
            ...
            <div className="p-4 md:p-6 space-y-4">
              ...
              <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl">
                ...
                <div className="text-right">
                  ...
                  <span className="text-text-tertiary ml-2 tabular-nums">
                    {formatCurrency(paidInvoices.reduce((s, i) => s + Number(i.total_amount), 0))}
                  </span>
                </div>
              </div>
            ...
            {recentActivity.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-text-secondary text-sm">
                  Activity will appear here as sessions and payments are recorded.
                </p>
              </div>
            ) : (
              <div className="space-y-4">
                  ...
                  >
                    <div
                      className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                        activity.type === 'payment' ? 'bg-success/20' : 'bg-brand/20'
                      }`}
                    >
