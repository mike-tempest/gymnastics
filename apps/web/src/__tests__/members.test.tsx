import { Member, Squad } from '@club-manager/shared-types';
...
describe('MembersPage', () => {
  ...
  it('displays the total members count', async () => {
    render(<MembersPage />, { wrapper: createWrapper() });
  ...
  it('has an Add Member button', async () => {
    render(<MembersPage />, { wrapper: createWrapper() });
  ...
  it('shows an empty state when no members match the search', async () => {
    render(<MembersPage />, { wrapper: createWrapper() });
